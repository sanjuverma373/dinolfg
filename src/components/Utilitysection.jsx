...
import utilitydl from '../assets/images/edina-l.webp'
import cycledina from '../assets/images/c-dina.webp'
import roadmaptlayert from '../assets/images/roadmaplayer-t.webp'
import utilityLayer from '../assets/images/utilitylayer.webp'
import utilityTree from '../assets/images/utility-tree.webp'

const Utilitysection = () => {
  return (
        <div className='relative overflow-hidden xl:pb-[466px] md:pb-[300px] sm:pb-[190px] xl:pt-[230px] sm:pt-[150px] pt-[100px] pb-[150px] bg-[#0A4740]'>
        <div className='container mx-auto xl:max-w-[1038px] xl:px-3 px-6 relative z-10'>
            ...
            <div className='relative z-10 xl:mt-[158px] max-lg:overflow-hidden lg:mt-[100px] md:mt-[70px] mt-[40px] rounded-[20px] border border-solid lg:h-[266px] border-white bg-[#09655A] lg:py-[62px] pt-[40px] lg:pl-[39px] lg:pr-[26px] px-[20px] flex lg:justify-between lg:flex-row flex-col'>
                <div data-aos="fade-right">
                    <p className='max-w-[681px] xl:text-[32px] lg:text-[29px] sm:text-[32px] text-[23px] font-normal text-white leading-[119%] font-Balsamiq'>We are going to work hard in otder to add <span className='text-[#8EC627] cursor-pointer'>$</span>
                    ...
                    <p className='max-w-[695px] xl:text-[32px] lg:text-[29px] sm:text-[32px] text-[23px] font-normal text-white mt-[28px] leading-[120%] font-Balsamiq'>You will be able to buy a lot of things with <span className='text-[#8EC627] cursor-pointer'>$</span>
                        <span className='text-[#FBA11D] cursor-pointer'>D</span>
                        <span className='text-[#23AAAC] cursor-pointer'>I</span>
                        <span className='text-[#D45B07] cursor-pointer'>N</span>
        ...
        <img src={roadmaptlayert} alt="TimelineLayer" className='absolute left-0 right-0 bottom-[-16px] w-full' />
    </div>
  )
}
