  ...
  return (
    <div className=' overflow-hidden bg-[url(./assets/webps/bgheaderimg.webp)] lg:bg-full bg-cover bg-center bg-repeat xl:min-h-screen sm:h-[730px] md:h-[874px] lg:h-[810px] h-[660px] relative z-50'>
      ...
      <div className=' max-w-[935px] px-3 mx-auto w-full'>
        <img className=' object-cover absolute bottom-[6%] right-[10%] lg:max-w-[183px] xl:max-w-[211px] sm:max-w-[140px] max-w-[100px]  animate-flip w-full z-10 ' src={acycled} alt="#" />
        ...
        <div className=' object-cover grid lg:grid-cols-2 gap-[30px] lg:gap-[100px] pt-[83px]'>
             <div className=' flex justify-center lg:justify-start items-start lg:items-center order-2 lg:order-1 lg:pt-[90px]  '>
