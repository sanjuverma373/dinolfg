...
import acycled from '../assets/images/a-cycle-d.webp'
import arod from '../assets/images/aro-d.webp'
import cycled from '../assets/images/cycle-d.webp'


const Headersection = () => {
  return (
    <div className=' overflow-hidden bg-[url(./assets/images/bgheaderimg.webp)] lg:bg-full bg-cover bg-center bg-repeat xl:min-h-screen sm:h-[730px] md:h-[874px] lg:h-[810px] h-[660px] relative z-0'>
      <Navsection/>
      <div className=' max-w-[935px] px-3 mx-auto w-full'>
        ...
        <div className=' object-cover grid lg:grid-cols-2 gap-[30px] lg:gap-[100px] pt-[83px]'>
             <div className=' flex justify-center lg:justify-start items-start lg:items-center order-2 lg:order-1 lg:pt-[100px]  '>
                <img className=' object-cover w-full max-w-[300.14px] sm:max-w-[394.14px] h-full min-h-[170.86px] sm:min-h-[240.86px]' src={arod} alt="#" />
             </div>
