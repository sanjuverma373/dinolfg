                        ...
                        <div className=' max-w-[1132px] mx-auto px-3 w-full pt-7'>
                                <div className=' bg-white rounded-[61px] border-b-4 pt-2 pb-1 pl-6 pr-[7px] border-black'>
                                        <div className=' flex items-center justify-between relative'>
                                                ...
                                                <ul className={` ${first ? "left-0" : "left-[-100%]"} flex items-center gap-[28px] duration-300  max-lg:justify-center max-lg:flex-col max-lg:text-black max-lg:w-full max-lg:h-full  max-lg:fixed max-lg:top-0 max-lg:z-20 max-lg:bg-white`}>
