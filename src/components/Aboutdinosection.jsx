...
import abouttree1 from '../assets/webps/about-tree-1.webp';
import abouttree2 from '../assets/webps/about-tree-2.webp';
import dragon from '../assets/webps/about-dragon.webp';
            ...
            <div id='about' className='bg-[#09655A] sm:pt-[76px] pt-[8px] sm:pb-[17px] pb-[30px] mt-[-2px]'>
                <div className="relative z-10">
                    <div className='container mx-auto xl:max-w-[1157px] px-3 xl:px-6'>
                        ...
                        <div data-aos="zoom-in" className='flex flex-col items-center justify-center md:px-0 sm:px-7 px-3 lg:px-14'>
